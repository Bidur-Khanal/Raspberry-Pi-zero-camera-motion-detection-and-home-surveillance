            ...
            try:
                    while True:
                            ...
                            if detect_motion(camera):
                                    ...
                                    camera.split_recording('after.h264',splitter_port=2,resize=(1920,1080))
                                    ...
                                    while detect_motion(camera):
                                            camera.wait_recording(0.3,splitter_port=2)
                                    print('Motion stopped!')
                                    camera.split_recording(stream,format='h264',splitter_port=2)
